...
class HebrewDeryptController: UIViewController, UITextViewDelegate {
    ...
    override func loadView() {
        ...
        let enterText = UILabel(frame: CGRect(x: 10, y: 20, width: self.view.frame.width - 40, height: 60))
        enterText.text = "Write here using keyboard extension, you will get direct translation:"
        enterText.numberOfLines = 0;
        scrollView.addSubview(enterText)
        
        let sampleTextField = UITextView(frame: CGRect(x: 10, y: 80, width: self.view.frame.width - 40, height: (self.view.frame.height/2) - 160))
        ...
        thisText.text = "Original text here:"
